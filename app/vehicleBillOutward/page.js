    ...
    const fetchDataAndRSTNo = async () => {
      try {
        const [vehicleResponse, rstNoResponse] = await Promise.all([
          ...
          axios.get("https://vehicle-weight-backend.vercel.app/api/weightOutward/weight/getNextRSTNo"),
        ]);
      ...
      try {
        const [customerResponse, vehicleResponse, materialResponse] =
          await Promise.all([
            ...
            axios.get("https://vehicle-weight-backend.vercel.app/api/vehical/vehicles"),
            axios.get("https://vehicle-weight-backend.vercel.app/api/material/materials"),
          ]);
...
//   };
  ...
  useEffect(() => {
    const fetchWeights = async () => {
      try {
        const response = await axios.get("https://vehicle-weight-backend.vercel.app/api/weightOutward/weights");
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      await axios.patch(`https://vehicle-weight-backend.vercel.app/api/weightOutward/weights/${editingWeight._id}`, weightData);
