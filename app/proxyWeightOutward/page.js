...
const ProxyWeightOutward = () => {
    ...
    const fetchDataAndRSTNo = async () => {
      try {
        const [vehicleResponse, rstNoResponse] = await Promise.all([
          axios.get("http://localhost:5000/api/vehical/vehicles"),
          axios.get("http://localhost:5000/api/proxyWeightOutward/weight/getNextRSTNo"),
        ]);
  ...
  useEffect(() => {
    const fetchSerialWeight = async () => {
      try {
        ...
        setTareWeight(response.data.weight);
      } catch (error) {
  ...
  useEffect(() => {
    const fetchVehicles = async () => {
      try {
        const response = await axios.get(
          "http://localhost:5000/api/vehical/vehicles"
        );
  ...
  const handleVehicleRTONoChange = async (event) => {
    ...
    try {
      const response = await axios.get(
        `http://localhost:5000/api/vehical/vehicles/details/${rtOno}`
      );
    ...
    const fetchData = async () => {
      try {
        const [customerResponse, vehicleResponse, materialResponse] =
          await Promise.all([
            axios.get("http://localhost:5000/api/coustomer/coustomers"),
            axios.get("http://localhost:5000/api/vehical/vehicles"),
            axios.get("http://localhost:5000/api/proxyMaterial/proxyMaterials"),
...
//       await axios.post("http://localhost:5000/api/weightOutward/weights", weightData);
...
//   };
  ...
  const handleSave = async (event) => {
    ...
    try {
      ...
      // Make the API call to save the data if needed
      await axios.post("http://localhost:5000/api/proxyWeightOutward/weights", weightData);
  ...
  useEffect(() => {
    const fetchWeights = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/proxyWeightOutward/weights");
  ...
  const handleEdit = async (weight) => {
    try {
      ...
      setEditedData({
        ...
        grossWeight: tareWeightData ? tareWeightData.weight : '',
        ...
        vehicalRTONo: weight.vehicalRTONo,
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      const tareWeightValue = tareWeightData ? tareWeightData.weight : 0; // Corrected usage
      const netWeightValue =  (tareWeightData ? tareWeightData.weight : 0) -  (editedData.tareWeight);
      ...
      await axios.patch(`http://localhost:5000/api/proxyWeightOutward/weights/${editingWeight._id}`, weightData);
        ...
        <html>
          ...
          <body>
            ...
            <div class="counter-content">
              ...
              <p>Net Weight: ${weightData.netWeight} KG</p>
              <p>Tare Weight: ${editedData.tareWeight} KG</p>
              <p>Gross Weight: ${weightData.grossWeight} KG</p>
            </div>
            <div class="signature">
             <p>Operator's Signature : </p>
  ...
  return (
    <>
 <ProxySidebar/>
      <div class="p-4 lg:pl-72 lg:w-full md:pl-72 md:w-full min-h-screen">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
          <div className="bg-white rounded-lg shadow-lg">
            {/* Modal header */}
            <div className="flex items-center justify-between p-4 border-b rounded-t">
              <h3 className="text-lg font-semibold text-gray-900">
                Add New Weight Outward
              </h3>
              {/* Close button */}
            </div>
            {/* Modal body */}
              ...
              <div className="bg-white p-8 rounded-lg">
                ...
                <form onSubmit={handleEditSubmit}>
                  ...
                  <input
                    ...
                    value={( parseFloat(tareWeightData ? tareWeightData.weight : 0) - parseFloat(editedData.tareWeight) ).toFixed(2)}
...
export default ProxyWeightOutward;
