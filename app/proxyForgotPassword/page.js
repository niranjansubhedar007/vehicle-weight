...
const ProxyForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://niranjan.rajpawar.xyz/api/proxyLogin/forgotPassword', { username });
  ...
  return (
    <div>
      <section className="bg-gray-50 dark:bg-gray-900 font-sans text-black">
...
export default ProxyForgotPassword;
