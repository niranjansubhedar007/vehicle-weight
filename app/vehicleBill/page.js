...
const Weight = () => {
    ...
    const fetchDataAndRSTNo = async () => {
      try {
        const [vehicleResponse, rstNoResponse] = await Promise.all([
          ...
          axios.get("https://vehicle-weight-backend.vercel.app/api/weight/weight/getNextRSTNo"),
        ]);
  ...
  //     await axios.post("https://vehicle-weight-backend.vercel.app/api/weight/weights", weightData);
  ...
  const closePopup = () => {
    ...
    const handleEditSubmit = async (e) => {
      ...
      try {
        ...
        await axios.patch(`https://vehicle-weight-backend.vercel.app/api/weight/weights/${editingWeight._id}`, weightData);
