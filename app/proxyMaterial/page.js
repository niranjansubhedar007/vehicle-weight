  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://vehicle-weight-backend.vercel.app/api/proxyMaterial/proxyMaterials",
        { materialName }
      );
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      const response = await axios.patch(
        `https://vehicle-weight-backend.vercel.app/api/proxyMaterial/proxyMaterials/${materialId}`,
  ...
  const handleDeleteConfirmation = async () => {
    try {
      const response = await axios.delete(
        `https://vehicle-weight-backend.vercel.app/api/proxyMaterial/proxyMaterials/${materialToDelete}`
      );
...
const moveToProxyWeight =()=>{
   router.push("/proxyVehicleBill")
}
            ...
            <div className=" bg-white shadow-md rounded-md">
              <div className="flex flex-col md:flex-col lg:flex-row py-4 px-4 items-center justify-between mb-4 ">
                ...
                <div className="flex flex-col md:flex-row items-center">
                  ...
                  <div>
                    <FontAwesomeIcon icon={faAngleRight} onClick={moveToProxyWeight} className="cursor-pointer"/>
                  </div>
                </div>
              </div>
